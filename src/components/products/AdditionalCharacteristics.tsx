...
export const AdditionalCharacteristics: FC = () => {
  const { register } = useFormContext();
  const { fields, remove, prepend } = useCreateProduct();

  return (
    <div className="border-b-2 lg:border-none border-gray-300 pb-2">
      <h3 className="text-parM font-medium mb-2">Додаткові характеристики</h3>
      <ClickButton
